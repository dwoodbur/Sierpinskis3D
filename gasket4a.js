...
*/
	/*
    var colorA = vec3(1.0, 1.0, 0.0);
    var colorB = vec3(0.0, 1.0, 1.0);
    var floorColor;
	var i=0;
	for(var z=2.0; z > -2.0; z-=.10) {
		for(var x=-2.0; x < 2.0; x+=.10) {
			if(i%2)
				floorColor = 0;
			else
				floorColor = 1;
			...
			square( vec3(x,-1,z), vec3(x+.1,-1,z), vec3(x,-1,z-.1), vec3(x+.1,-1,z-.1), floorColor );
			++i;
		}
		++i;
	}
